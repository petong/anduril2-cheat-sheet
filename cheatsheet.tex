...
\begin{tabularx}{3.80 cm}{p{0.50 cm} x{4.5 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{5.41 cm}}{\bf\textcolor{white}{Battery Check Mode (3C)}}  \tn
% Row 0
\SetRowColor{LightBackground}
1C & Off \tn
% Row Count 1 (+ 1)
