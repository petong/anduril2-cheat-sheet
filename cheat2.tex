...
\begin{tabularx}{3.80 cm}{p{0.50 cm} x{3.5 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{4.41 cm}}{\bf\textcolor{white}{Battery Check Mode (3C)}}  \tn
% Row 0
\SetRowColor{LightBackground}
1C & Off \tn
% Row Count 1 (+ 1)
...
\begin{tabularx}{3.80 cm}{p{0.50 cm} x{3.5 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{4.41 cm}}{\bf\textcolor{white}{Ramp Mode (On)}}  \tn
% Row 0
\SetRowColor{LightBackground}
1C & On \tn
% Row Count 1 (+ 1)
...
\begin{tabularx}{4.0 cm}{p{0.10 cm} x{0.75 cm} x{2.70 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{3}{x{4.41 cm}}{\bf\textcolor{white}{Ramp Config Menu (Smooth) 7H from On}}  \tn
% Row 0
\SetRowColor{LightBackground}
...
\begin{tabularx}{4.0 cm}{p{0.10 cm} x{0.75 cm} x{2.70 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{3}{x{4.41 cm}}{\bf\textcolor{white}{Ramp Config (Stepped) 7H from On}}  \tn
% Row 0
\SetRowColor{LightBackground}
1 & Floor & default: 20/150 \tn
% Row 1
...
% Ramp Extras from On
\begin{tabularx}{3.80 cm}{p{0.10 cm} x{3.90 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{4.41 cm}}{\bf\textcolor{white}{Ramp Extras 10H from On}}  \tn
% Row 0
\SetRowColor{LightBackground}
...
% Row 2
\SetRowColor{LightBackground}
3 & Ramp after Moon or Not \tn
% Row 3
\SetRowColor{white}
4 & Advanced UI turbo style \tn
\hhline{>{\arrayrulecolor{DarkBackground}}--}
\end{tabularx}
\par\addvspace{1.3em}
...
% lockout
\begin{tabularx}{3.80 cm}{p{1 cm} x{3 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{4.41 cm}}{\bf\textcolor{white}{Lockout}}  \tn
% Row 0
\SetRowColor{LightBackground}
...
\hhline{>{\arrayrulecolor{DarkBackground}}--}
\end{tabularx}
\par\addvspace{4.25 em}

% Strobe Mode
\begin{tabularx}{3.80 cm}{p{0.50 cm} x{3.5 cm} }
\SetRowColor{DarkBackground}
\mymulticolumn{2}{x{4.41 cm}}{\bf\textcolor{white}{Strobe Mode 3H from Off}}  \tn
% Row 0
\SetRowColor{LightBackground}
1C & Turn Off \tn
% Row Count 1 (+ 1)
...
\hhline{>{\arrayrulecolor{DarkBackground}}--}
\SetRowColor{LightBackground}
\mymulticolumn{2}{x{4.41 cm}}{Candle -\textgreater{} Bike -\textgreater{} Party -\textgreater{} Tactical -\textgreater{} Lightning}  \tn
\hhline{>{\arrayrulecolor{DarkBackground}}--}
\end{tabularx}
\par\addvspace{1.3em}

% Aux Colors
\begin{tabularx}{4.41 cm}{X}
\SetRowColor{DarkBackground}
\mymulticolumn{1}{x{4.41 cm}}{\bf\textcolor{white}{Aux Colors}}  \tn
% Row 0
\SetRowColor{LightBackground}
\mymulticolumn{1}{x{4.41 cm}}{7H from Off or Lockout} \tn
% Row Count 1 (+ 1)
\hhline{>{\arrayrulecolor{DarkBackground}}-}
\SetRowColor{LightBackground}
\mymulticolumn{1}{x{4.41 cm}}{- Red \newline  - Yellow (Red+Green) \newline  - Green \newline  - Cyan (Green+Blue) \newline  - Blue \newline  - Purple (Blue+Red) \newline  - White (Red+Green+Blue) \newline  - Disco \newline  - Rainbow \newline  - Voltage}  \tn
\hhline{>{\arrayrulecolor{DarkBackground}}-}
\end{tabularx}
\par\addvspace{1.3em}
